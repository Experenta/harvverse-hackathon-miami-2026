      ...
      <div className="relative border-b border-white/5 bg-[color:var(--color-harv-bg)]/50 backdrop-blur">
        <div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-10">
          <div className="flex flex-wrap items-center gap-3">
            <span className="inline-flex items-center gap-2 rounded-md border border-[color:var(--color-harv-accent)]/30 bg-[color:var(--color-harv-accent)]/8 px-2 py-1 font-mono text-[10px] uppercase tracking-wider text-[color:var(--color-harv-accent)]">
              <ExclamationTriangleIcon className="h-3 w-3" />
              Admin · operator
            </span>
            <span className="text-xs text-muted-harv">Role-restricted controls · compressed demo time</span>
          </div>
